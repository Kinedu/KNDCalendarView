#
# Be sure to run `pod lib lint KNDCalendarView.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'KNDCalendarView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'KNDCalendarView' => ['KNDCalendarView/Assets/*.png']
  # }
